...
namespace CrearDocumentoPDF
{
    public class SqlParameters
    {
        ...
        public SqlParameter[] ParamBO(DateTime stDate, DateTime endDate)
        {

            List<SqlParameter> parameters = new List<SqlParameter>
            {
                new SqlParameter("@Company", SqlDbType.VarChar, 50) { Value = "SWMX"},
                new SqlParameter("@StartDate", SqlDbType.VarChar, 50) { Value =  String.Format("{0:yyyyMMdd}", stDate)},
                new SqlParameter("@EndDate", SqlDbType.VarChar, 50) { Value = String.Format("{0:yyyyMMdd}", endDate)},
             };

            return parameters.ToArray();
        }

        public SqlParameter[] ParamBO(int FiscalYear, int FiscalPeriod)
        {

            List<SqlParameter> parameters = new List<SqlParameter>
            {

                new SqlParameter("@FiscalYear", SqlDbType.Int, 50) { Value = FiscalYear},
                new SqlParameter("@FiscalPeriod", SqlDbType.Int, 50) { Value = FiscalPeriod},
             };
        ...
        #region KPI
        public SqlParameter[] pKPIProdStatus(DmProcess2 dm)
        {
        ...
        public SqlParameter[] pKPIConsulta(DmProcess2 dm)
        {
        ...
        public SqlParameter[] pKPIReport(DmKPIReport2 dm)
        {
        ...
        public SqlParameter[] pFiscalPeriod(int FiscalYear, int FiscalPeriod)
        {
            ...
            List<SqlParameter> parameters = new List<SqlParameter>
            {
                new SqlParameter("@FiscalYear", SqlDbType.Int, 50) { Value = FiscalYear},
                new SqlParameter("@FiscalPeriod", SqlDbType.Int, 50) { Value = FiscalPeriod},
                 new SqlParameter("@strCompany", SqlDbType.VarChar, 50) { Value = "SWMX"},
        ...
        public SqlParameter[] pKPIReport(DmKPIReport2 dm, int iYear, string strCompany)
        {
            ...
            List<SqlParameter> parameters = new List<SqlParameter>
            {
                ...
                new SqlParameter("@Company", SqlDbType.VarChar, 50) { Value = strCompany},
        ...
        public SqlParameter[] ReportsEmailAddress(string strCompany, string ReportName)
        {

            List<SqlParameter> parameters = new List<SqlParameter>
            {
                new SqlParameter("@Company", SqlDbType.VarChar, 50) { Value = strCompany},
                new SqlParameter("@ReportName", SqlDbType.VarChar, 100) { Value = ReportName},
            };
