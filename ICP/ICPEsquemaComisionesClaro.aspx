<%@ Page Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ICPEsquemaComisionesClaro.aspx.cs" Inherits="ICP.ICPEsquemaComisionesClaro" %>


<asp:Content ID="Content1" ContentPlaceHolderID="Contenedor" runat="server">
    <link href="CSS/ICPEsquemaComisionesClaro.css" rel="stylesheet" />
        ...
        <div>
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Sales Commission (Tema Claro - propuesta)</h3>
