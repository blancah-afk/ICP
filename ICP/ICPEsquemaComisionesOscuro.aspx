<%@ Page Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ICPEsquemaComisionesOscuro.aspx.cs" Inherits="ICP.ICPEsquemaComisionesOscuro" %>


<asp:Content ID="Content1" ContentPlaceHolderID="Contenedor" runat="server">
    <link href="CSS/ICPEsquemaComisionesOscuro.css" rel="stylesheet" />
        ...
        <div>
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Sales Commission (Tema Oscuro - propuesta)</h3>
