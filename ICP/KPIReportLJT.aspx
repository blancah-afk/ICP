<%@ Page Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="KPIReportLJT.aspx.cs" Inherits="ICP.KPIReportLJT" %>
        ...
        <div class=" row">
            <div class="col-md-12">
                <div class="box box-danger">
                    <div class="box-header with-border">
                        <h3 class="box-title">Key Performance Indicator (KPI) Report Lock Joint Tube</h3>
