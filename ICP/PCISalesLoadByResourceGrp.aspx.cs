...
namespace ICP
{
    public partial class PCISalesLoadByResourceGrp : System.Web.UI.Page
    {
        private int menuPCI;
        ...
        {
            string strLastUpd = Convert.ToString(DateTime.Now);
            if (strLastUpd != "")
            {
                lblLastUpdate.Text = "Last Updated:  " + strLastUpd;
            }
        }
    }
}