...
namespace ICP
{
    public partial class PCIShipments : System.Web.UI.Page
    {
        private int menuPCI;
        ...
        {
            string strLastUpd = DateTime.Now.ToString();
            if (strLastUpd != "")
            {
                lblLastUpdate.Text = "Data from current Month - Last Updated:  " + strLastUpd;
            }
        }
    }
}