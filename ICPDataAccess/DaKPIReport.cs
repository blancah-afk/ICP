...
namespace ICPDataAccess
{
    public class DaKPIReport
    {
        ...
        public DataSet ds_KPIReport(string consulta, int? idCategory, int? idSubCategory, int iYear, string strCompany)
        {
          
            DataSet ds = new DataSet();
            DmKPIReport dm = new DmKPIReport();
        ...
        public DataSet ds_KPIReportDtl(string consulta, int? idCategory, int? idSubCategory, int iYear, string strCompany)
        {
            ...
            DataSet ds = new DataSet();
            List<DmKPIReport> lstItems = new List<DmKPIReport>();
            List<DmKPIReport> lstDtl = new List<DmKPIReport>();
            ...
            foreach (DmKPIReport item in lstItems)
            {
        ...
        public List<DmKPIReport> lst_KPIReport(string consulta, int? idCategory, int? idSubCategory, int iYear, string strCompany)
        {
            DataSet ds = new DataSet();
            List<DmKPIReport> lres = new List<DmKPIReport>();
            DmKPIReport dmp = new DmKPIReport();
            SqlParameters param = new SqlParameters();
        ...
        public List<DmKPIReport> lst_KPIReportItems(string consulta, int? idCategory, int? idSubCategory, int iYear, string strCompany)
        {
            DataSet ds = new DataSet();
            List<DmKPIReport> lres = new List<DmKPIReport>();
            DmKPIReport dmp = new DmKPIReport();
        ...
        {
            DataSet ds = new DataSet();
            ds = ds_KPIReportEmailAddressGroup();
