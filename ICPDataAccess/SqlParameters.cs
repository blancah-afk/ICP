...
namespace ICPDataAccess
{
    public class SqlParameters
    {
        ...
        public SqlParameter[] pFiscalPeriod(int FiscalYear, int FiscalPeriod, string strCompany)
        {
            ...
            List<SqlParameter> parameters = new List<SqlParameter>
            {
                new SqlParameter("@FiscalYear", SqlDbType.Int, 50) { Value = FiscalYear},
                new SqlParameter("@FiscalPeriod", SqlDbType.Int, 50) { Value = FiscalPeriod},
                 new SqlParameter("@strCompany", SqlDbType.VarChar, 50) { Value = strCompany},
        ...
        public SqlParameter[] pKPIReport(DmKPIReport dm, int iYear, string strCompany)
        {
